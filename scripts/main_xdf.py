...
def main_xdf(
    session_ID="sub002_mSST_DBS_ON_v2",
    fname_lfp="sub-002_ses-Fu12mMedOn02_task-MSST_acq-StimOnB_mod-BrainSenseBip_run-1_v2.mat",
    ch_idx_lfp=0,
    fname_external="sub-002_ses-mSST_ON_task-Default_run-001_eeg.xdf",
    BIP_ch_name="BIP 01",
